    ...
    <div class="section-wrapper" data-scroll-section>
        ...
        <header class="page-header" data-background="{{ theme_path }}/assets/videos/video.mp4">
            ...
            <div class="inner">
                ...
                <p>{{ render_widget('breadcrumb',['id':112],['viewsDir': widgets_volt,'view':'breadcrumb-1']) }}</p>
            </div>
            <!-- end inner -->
        </header>
        <!-- end page-header -->
...
{#                            <li>Năm xuất bản: {{ post.data.year }}</li>#}
                        ...
                        <h4>Giới thiệu</h4>
                        {% set desc = post.data.intro | getAttribute(language) %}
                ...
                <div class="row">
                    ...
                    {{ render_widget('bookstore.book-listing',['limit':4],['viewsDir': widgets_volt,'view':'modules/bookstore/book-listing-1']) }}
                </div>

    ...
    <section class="twoColumns container">
        ...
        <header class="contentFiltersHeadingWrap row">
            <div class="col-xs-12 col-sm-10">
                ...
                {% endif %}
                <h1 class="fontNeuron">{{ publisher.data.title.vi }}</h1>
            </div>
...
{#                        </div>#}
{#                    </header>#}
                    {{ render_widget('bookstore.book-listing',['limit':10,'current_page':current_page, 'publisher':publisher.uuid],['viewsDir': widgets_volt,'view':'bookstore-book-listing-4']) }}

                </div>
            </div>
            <div class="col-xs-12 col-md-4">
                {{ partial('modules/bookstore/partials/sidebar-3') }}
            </div>

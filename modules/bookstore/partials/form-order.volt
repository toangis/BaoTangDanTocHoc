        ...
        {% if mode == 'message' %}
            <div class="col-md-12">
                <div class="mb-3">
                    ...
                    <textarea class="form-control w-100" name="con_message" id="fc-message" placeholder="Vui lòng ghi rõ số tạp chí và số lượng đặt mua, chúng tôi sẽ liên hệ lại để xác nhận"></textarea>
                </div>
            </div>
        {% endif %}

        ...
        <div class="section-wrapper" data-scroll-section>
            ...
            <section class="content-section" data-background="#fffbf7">
                <div class="container">
                    ...
                    {{ partial('partials/group/nam-dao') }}
                    <br/>
    ...
    <script>
        (function ($) {
            ...
            $(document).ready(function ($) {
                ...
                // Calculate SVG size
                // var svgRatio = $('#ethnic-map-wrapper svg img').width()/$('#ethnic-map-wrapper').width();
                // $('#ethnic-map-wrapper svg').attr('width', $('#ethnic-map-wrapper').width());
                // $('#ethnic-map-wrapper svg').attr('height', $('#ethnic-map-wrapper svg img').height());
